...
exports.serveCustomWebpackBrowser = (options, context) => {
    ...
    return rxjs_1.from(setup())
        .pipe(operators_1.switchMap(customWebpackOptions => build_angular_1.executeDevServerBuilder(options, context, common_1.getTransforms(customWebpackOptions, context))));
};
