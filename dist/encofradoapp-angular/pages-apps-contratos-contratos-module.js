...
let ContratosCreateUpdateComponent = class ContratosCreateUpdateComponent {
    constructor(router, fb, dialog, cd, snackbar, createContratoGQL, createArticuloAlquilerGQL, datePipe) {
        this.router = router;
        this.fb = fb;
        this.dialog = dialog;
        this.cd = cd;
...
ContratosCreateUpdateComponent.ctorParameters = () => [
...
let CloseDialogComponent = class CloseDialogComponent {
...
CloseDialogComponent.ctorParameters = () => [
...
const GetContratos = src_app_services_contratos__WEBPACK_IMPORTED_MODULE_26__["queryGetContratos"];
let ContratosComponent = class ContratosComponent {
    ...
    getData() {
        this.data = this.apollo
            ...
            .valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_23__["map"])(({ data }) => data.contrato_alquiler));
        return this.data;
    }
    ngOnInit() {
...
let CreateArticuloAlquilerGQL = class CreateArticuloAlquilerGQL extends apollo_angular__WEBPACK_IMPORTED_MODULE_2__["Mutation"] {
    constructor() {
        super(...arguments);
...
let CreateContratoGQL = class CreateContratoGQL extends apollo_angular__WEBPACK_IMPORTED_MODULE_2__["Mutation"] {
    constructor() {
        super(...arguments);
        this.document = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default.a `
    mutation MyMutation(
...
const queryGetContratos = graphql_tag__WEBPACK_IMPORTED_MODULE_1___default.a `
  query MyQuery {
    contrato_alquiler {
      cliente {
        id
...
`;
const queryGetFullContrato = graphql_tag__WEBPACK_IMPORTED_MODULE_1___default.a `
  query MyQuery {
    contrato_alquiler {
      cliente {
        nombre
...
//# sourceMappingURL=pages-apps-contratos-contratos-module.js.map