...
const routes = [
    {
        ...
        children: [
            {
                path: 'table',
                loadChildren: () => Promise.all(/*! import() | contacts-table-contacts-table-module */[__webpack_require__.e("default~components-checkbox-components-checkbox-module~components-overview-components-overview-modul~2bad73dc"), __webpack_require__.e("default~components-dialogs-components-dialogs-module~components-overview-components-overview-module~~e8ad5f8f"), __webpack_require__.e("default~contacts-table-contacts-table-module~pages-apps-calendar-calendar-module~pages-apps-clientes~ea910b37"), __webpack_require__.e("default~contacts-table-contacts-table-module~pages-apps-clientes-aio-table-module~pages-apps-contrat~601e5afe"), __webpack_require__.e("default~contacts-table-contacts-table-module~pages-apps-clientes-aio-table-module~pages-apps-contrat~d964ba47"), __webpack_require__.e("common"), __webpack_require__.e("contacts-table-contacts-table-module")]).then(__webpack_require__.bind(null, /*! ./contacts-table/contacts-table.module */ "./src/app/pages/apps/contacts/contacts-table/contacts-table.module.ts")).then(m => m.ContactsTableModule)
            }
        ]
    }
];
...
//# sourceMappingURL=pages-apps-contacts-contacts-module.js.map