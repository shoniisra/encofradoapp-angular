(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["contacts-table-contacts-table-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContactsEditComponent = /** @class */ (function () {
                ...
                ContactsEditComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    if (this.contactId) {
                        this.contact = _static_data_contacts__WEBPACK_IMPORTED_MODULE_3__["contactsData"].find(function (c) { return c.id === _this.contactId; });
                        this.form.patchValue(this.contact);
                    }
                };
                ContactsEditComponent.prototype.toggleStar = function () {
                    if (this.contact) {
                        this.contact.starred = !this.contact.starred;
                    }
                };
                ContactsEditComponent.prototype.save = function () {
            ...
            ContactsEditComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContactsEditModule = /** @class */ (function () {
                function ContactsEditModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContactsDataTableComponent = /** @class */ (function () {
                ...
                ContactsDataTableComponent.prototype.ngOnInit = function () { };
                ContactsDataTableComponent.prototype.ngOnChanges = function (changes) {
                    if (changes.columns) {
                        this.visibleColumns = this.columns.map(function (column) { return column.property; });
                    }
                    if (changes.data) {
                ...
                ContactsDataTableComponent.prototype.emitToggleStar = function (event, id) {
                    event.stopPropagation();
                    this.toggleStar.emit(id);
                };
                ContactsDataTableComponent.prototype.ngAfterViewInit = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContactsTableMenuComponent = /** @class */ (function () {
                ...
                ContactsTableMenuComponent.prototype.ngOnInit = function () {
                };
                ContactsTableMenuComponent.prototype.setFilter = function (category) {
                    this.activeCategory = category;
                    if (category === 'starred') {
                        return this.filterChange.emit(_static_data_contacts__WEBPACK_IMPORTED_MODULE_3__["contactsData"].filter(function (c) { return c.starred; }));
                    }
                    if (category === 'all') {
                ...
                ContactsTableMenuComponent.prototype.isActive = function (category) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContactsTableRoutingModule = /** @class */ (function () {
                function ContactsTableRoutingModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContactsTableComponent = /** @class */ (function () {
                ...
                ContactsTableComponent.prototype.ngOnInit = function () {
                };
                ContactsTableComponent.prototype.openContact = function (id) {
                    this.dialog.open(_components_contacts_edit_contacts_edit_component__WEBPACK_IMPORTED_MODULE_12__["ContactsEditComponent"], {
                        data: id || null,
                        width: '600px'
                    });
                };
                ContactsTableComponent.prototype.toggleStar = function (id) {
                    var contact = this.tableData.find(function (c) { return c.id === id; });
                    if (contact) {
                        contact.starred = !contact.starred;
                    }
                };
                ContactsTableComponent.prototype.setData = function (data) {
                    this.tableData = data;
                    this.menuOpen = false;
                };
                ContactsTableComponent.prototype.openMenu = function () {
                    this.menuOpen = true;
                };
                return ContactsTableComponent;
            }());
            ContactsTableComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContactsTableModule = /** @class */ (function () {
                function ContactsTableModule() {
                }
