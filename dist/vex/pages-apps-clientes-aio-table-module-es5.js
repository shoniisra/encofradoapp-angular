...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-apps-clientes-aio-table-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Cliente = /** @class */ (function () {
                ...
                Object.defineProperty(Cliente.prototype, "address", {
                    get: function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AioTableRoutingModule = /** @class */ (function () {
                function AioTableRoutingModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            //Manejo de Datos
            //Modelo
            var GetClientes = src_app_services_clientes__WEBPACK_IMPORTED_MODULE_27__["queryGetClientes"];
            var AioTableComponent = /** @class */ (function () {
                function AioTableComponent(dialog, apollo, deleteClienteGQL) {
                    this.dialog = dialog;
                    this.apollo = apollo;
                ...
                Object.defineProperty(AioTableComponent.prototype, "visibleColumns", {
                    get: function () {
                        return this.columns
                ...
                AioTableComponent.prototype.getData = function () {
                ...
                AioTableComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                AioTableComponent.prototype.ngAfterViewInit = function () {
                    this.dataSource.paginator = this.paginator;
                    this.dataSource.sort = this.sort;
                };
                AioTableComponent.prototype.createCustomer = function () {
                    var _this = this;
                    ...
                    this.dialog
                        ...
                        if (customer) {
                            _this.customers.unshift(new src_app_models_cliente_model__WEBPACK_IMPORTED_MODULE_26__["Cliente"](customer));
                            _this.subject$.next(_this.customers);
                        }
                    });
                };
                AioTableComponent.prototype.updateCustomer = function (customer) {
                    var _this = this;
                    this.dialog
                        .open(_customer_create_update_customer_create_update_component__WEBPACK_IMPORTED_MODULE_29__["CustomerCreateUpdateComponent"], {
                        data: customer,
                        ...
                        if (updatedCustomer) {
                             ...
                             */
                            var index = _this.customers.findIndex(function (existingCustomer) { return existingCustomer.id === updatedCustomer.id; });
                            _this.customers[index] = new src_app_models_cliente_model__WEBPACK_IMPORTED_MODULE_26__["Cliente"](updatedCustomer);
                            _this.subject$.next(_this.customers);
                        }
                    });
                };
                AioTableComponent.prototype.deleteCustomer = function (customer) {
                ...
                AioTableComponent.prototype.deleteCustomers = function (customers) {
                    var _this = this;
                    customers.forEach(function (c) { return _this.deleteCustomer(c); });
                };
                AioTableComponent.prototype.onFilterChange = function (value) {
                    if (!this.dataSource) {
                        return;
                    }
                    value = value.trim();
                ...
                AioTableComponent.prototype.toggleColumnVisibility = function (column, event) {
                    event.stopPropagation();
                    event.stopImmediatePropagation();
                    column.visible = !column.visible;
                };
                AioTableComponent.prototype.isAllSelected = function () {
                    var numSelected = this.selection.selected.length;
                    var numRows = this.dataSource.data.length;
                    return numSelected === numRows;
                };
                AioTableComponent.prototype.masterToggle = function () {
                    var _this = this;
                    this.isAllSelected()
                        ? this.selection.clear()
                        : this.dataSource.data.forEach(function (row) { return _this.selection.select(row); });
                };
                AioTableComponent.prototype.trackByProperty = function (index, column) {
                    return column.property;
                };
                AioTableComponent.prototype.ngOnDestroy = function () { };
                return AioTableComponent;
            }());
            AioTableComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AioTableModule = /** @class */ (function () {
                function AioTableModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            //icons
            //model
            var CustomerCreateUpdateComponent = CustomerCreateUpdateComponent_1 = /** @class */ (function () {
                function CustomerCreateUpdateComponent(defaults, dialogRef, fb, snackBar, createClienteGQL, updateClienteGQL) {
                ...
                CustomerCreateUpdateComponent.prototype.onlyNumberKey = function (event) {
                    return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57;
                };
                CustomerCreateUpdateComponent.prototype.openSnackbar = function (mensaje) {
                    this.snackBar.open(mensaje, "cerrar", {
                        duration: 3000,
                        horizontalPosition: "right",
                    });
                };
                CustomerCreateUpdateComponent.prototype.validateForm = function (customer) {
                ...
                CustomerCreateUpdateComponent.prototype.createCustomer = function () {
                    ...
                    if (this.validateForm(customer)) {
                        this.createClienteGQL
                            ...
                            var data = _a.data;
                            _this.openSnackbar("Cliente Guardado Exitosamente");
                            _this.dialogRef.close(customer);
                        }, function (error) {
                            console.log("Error al Guardar el cliente", error);
                            _this.openSnackbar("Error al Guardar el cliente");
                        });
                    }
                };
                CustomerCreateUpdateComponent.prototype.validarCedula = function (cedula) {
                    if (cedula.length == 13) {
                        var digito_ruc = cedula.substring(10, 13);
                        if (digito_ruc == "001") {
            ...
            CustomerCreateUpdateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CreateClienteGQL = /** @class */ (function (_super) {
                __extends(CreateClienteGQL, _super);
                function CreateClienteGQL() {
                    var _this = _super.apply(this, arguments) || this;
                    _this.document = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default.a(__makeTemplateObject(["\n    mutation MyMutation(\n      $cedula: String!\n      $direccion: String!\n      $direccion2: String!\n      $email: String!\n      $nombre: String!\n      $nombre2: String!\n      $observacion: String!\n      $telf1: String!\n      $telf2: String!\n      $telf3: String!\n    ) {\n      insert_cliente_one(\n        object: {\n          cedula: $cedula,\n          direccion: $direccion ,\n          direccion2: $direccion2 ,\n          email: $email ,\n          nombre: $nombre ,\n          nombre2: $nombre2 ,\n          observacion: $observacion,\n          telf1: $telf1,\n          telf2: $telf2,\n          telf3: $telf3\n        }\n      ) {\n        id\n      }\n    }\n  "], ["\n    mutation MyMutation(\n      $cedula: String!\n      $direccion: String!\n      $direccion2: String!\n      $email: String!\n      $nombre: String!\n      $nombre2: String!\n      $observacion: String!\n      $telf1: String!\n      $telf2: String!\n      $telf3: String!\n    ) {\n      insert_cliente_one(\n        object: {\n          cedula: $cedula,\n          direccion: $direccion ,\n          direccion2: $direccion2 ,\n          email: $email ,\n          nombre: $nombre ,\n          nombre2: $nombre2 ,\n          observacion: $observacion,\n          telf1: $telf1,\n          telf2: $telf2,\n          telf3: $telf3\n        }\n      ) {\n        id\n      }\n    }\n  "]));
                    return _this;
                }
                return CreateClienteGQL;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var graphql_tag__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! graphql-tag */ "./node_modules/graphql-tag/src/index.js");
            /* harmony import */ var graphql_tag__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(graphql_tag__WEBPACK_IMPORTED_MODULE_3__);
            var DeleteClienteGQL = /** @class */ (function (_super) {
                __extends(DeleteClienteGQL, _super);
                function DeleteClienteGQL() {
                    var _this = _super.apply(this, arguments) || this;
                    _this.document = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default.a(__makeTemplateObject(["\n    mutation MyMutation($id: Int!) {\n        delete_cliente_by_pk(id: $id) {\n        id\n      }\n    }\n  "], ["\n    mutation MyMutation($id: Int!) {\n        delete_cliente_by_pk(id: $id) {\n        id\n      }\n    }\n  "]));
                    return _this;
                }
                return DeleteClienteGQL;
            }(apollo_angular__WEBPACK_IMPORTED_MODULE_2__["Mutation"]));
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var graphql_tag__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! graphql-tag */ "./node_modules/graphql-tag/src/index.js");
            /* harmony import */ var graphql_tag__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(graphql_tag__WEBPACK_IMPORTED_MODULE_3__);
            var UpdateClienteGQL = /** @class */ (function (_super) {
                __extends(UpdateClienteGQL, _super);
                function UpdateClienteGQL() {
                    var _this = _super.apply(this, arguments) || this;
                    _this.document = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default.a(__makeTemplateObject(["\n    mutation MyMutation(\n      $id: Int!\n      $cedula: String!\n      $direccion: String!\n      $direccion2: String!\n      $email: String!\n      $nombre: String!\n      $nombre2: String!\n      $observacion: String!\n      $telf1: String!\n      $telf2: String!\n      $telf3: String!\n    ) {\n      update_cliente(\n        _set: {\n          cedula: $cedula\n          direccion: $direccion\n          direccion2: $direccion2\n          email: $email\n          nombre: $nombre\n          nombre2: $nombre2\n          observacion: $observacion\n          telf1: $telf1\n          telf2: $telf2\n          telf3: $telf3\n        }\n        where: { id: { _eq: $id } }\n      ) {\n        returning {\n          id\n        }\n      }\n    }\n  "], ["\n    mutation MyMutation(\n      $id: Int!\n      $cedula: String!\n      $direccion: String!\n      $direccion2: String!\n      $email: String!\n      $nombre: String!\n      $nombre2: String!\n      $observacion: String!\n      $telf1: String!\n      $telf2: String!\n      $telf3: String!\n    ) {\n      update_cliente(\n        _set: {\n          cedula: $cedula\n          direccion: $direccion\n          direccion2: $direccion2\n          email: $email\n          nombre: $nombre\n          nombre2: $nombre2\n          observacion: $observacion\n          telf1: $telf1\n          telf2: $telf2\n          telf3: $telf3\n        }\n        where: { id: { _eq: $id } }\n      ) {\n        returning {\n          id\n        }\n      }\n    }\n  "]));
                    return _this;
                }
                return UpdateClienteGQL;
            }(apollo_angular__WEBPACK_IMPORTED_MODULE_2__["Mutation"]));
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var queryGetClientes = graphql_tag__WEBPACK_IMPORTED_MODULE_1___default.a(__makeTemplateObject(["\n  query allPosts {\n    cliente {\n      id\n      cedula\n      direccion\n      direccion2\n      email\n      nombre\n      nombre2\n      observacion\n      telf1\n      telf2\n      telf3\n    }\n  }\n"], ["\n  query allPosts {\n    cliente {\n      id\n      cedula\n      direccion\n      direccion2\n      email\n      nombre\n      nombre2\n      observacion\n      telf1\n      telf2\n      telf3\n    }\n  }\n"]));
            /***/ 
        })
    }]);
//# sourceMappingURL=pages-apps-clientes-aio-table-module-es2015.js.map
//# sourceMappingURL=pages-apps-clientes-aio-table-module-es5.js.map
//# sourceMappingURL=pages-apps-clientes-aio-table-module-es5.js.map