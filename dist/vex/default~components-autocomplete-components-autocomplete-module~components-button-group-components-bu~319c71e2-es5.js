(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~components-autocomplete-components-autocomplete-module~components-button-group-components-bu~319c71e2"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HighlightDirective = /** @class */ (function () {
                 ...
                 */
                HighlightDirective.prototype.highlightElement = function (code, languages) {
                    var _this = this;
            ...
            var HighlightService = /** @class */ (function () {
                function HighlightService(options) {
                    ...
                    if (options) {
                        ...
                        options.languages().map(function (language) { return _this.registerLanguage(language.name, language.func); });
                        if (options.config) {
                 ...
                 */
                HighlightService.prototype.highlight = function (name, value, ignore_illegals, continuation) {
                 ...
                 * The subset can also be set with configure, but the local parameter overrides the option if set.
                 */
                HighlightService.prototype.highlightAuto = function (value, languageSubset) {
                 ...
                 */
                HighlightService.prototype.fixMarkup = function (value) {
                 ...
                 */
                HighlightService.prototype.highlightBlock = function (block) {
                 ...
                 * @param config
                 */
                HighlightService.prototype.configure = function (config) {
                    highlight_js_lib_highlight_js__WEBPACK_IMPORTED_MODULE_3___default.a.configure(config);
                };
                /**
                 * Applies highlighting to all <pre><code>..</code></pre> blocks on a page.
                 */
                HighlightService.prototype.initHighlighting = function () {
                 ...
                 */
                HighlightService.prototype.registerLanguage = function (name, language) {
                    highlight_js_lib_highlight_js__WEBPACK_IMPORTED_MODULE_3___default.a.registerLanguage(name, language);
                };
                /**
                 * @return The languages names list.
                 */
                HighlightService.prototype.listLanguages = function () {
                 ...
                 */
                HighlightService.prototype.getLanguage = function (name) {
...
//# sourceMappingURL=default~components-autocomplete-components-autocomplete-module~components-button-group-components-bu~319c71e2-es5.js.map
//# sourceMappingURL=default~components-autocomplete-components-autocomplete-module~components-button-group-components-bu~319c71e2-es5.js.map