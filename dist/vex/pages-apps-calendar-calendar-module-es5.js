...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-apps-calendar-calendar-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CalendarEventActionsComponent = /** @class */ (function () {
                function CalendarEventActionsComponent() {
                     ...
                     * @param {?} action
                     * @return {?}
                     */function (index, action) { return action.id ? action.id : action; });
                }
             ...
             * @param {?} event
             * @return {?}
             */function (index, event) { return event.id ? event.id : event; });
            /** @type {?} */
             ...
             * @param {?} hour
             * @return {?}
             */function (index, hour) { return hour.segments[0].date.toISOString(); });
            /** @type {?} */
            ...
            var CalendarAngularDateFormatter = /** @class */ (function () {
                 ...
                 * @return {?}
                 */
                CalendarAngularDateFormatter.prototype.monthViewColumnHeader = function (_h) {
                    var date = _h.date, locale = _h.locale;
                 ...
                 * @return {?}
                 */
                CalendarAngularDateFormatter.prototype.monthViewDayNumber = function (_h) {
                    var date = _h.date, locale = _h.locale;
                 ...
                 * @return {?}
                 */
                CalendarAngularDateFormatter.prototype.monthViewTitle = function (_h) {
                    var date = _h.date, locale = _h.locale;
                 ...
                 * @return {?}
                 */
                CalendarAngularDateFormatter.prototype.weekViewColumnHeader = function (_h) {
                    var date = _h.date, locale = _h.locale;
                    return Object(_angular_common__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(date, 'EEEE', locale);
                };
                /**
                 ...
                 * @return {?}
                 */
                CalendarAngularDateFormatter.prototype.weekViewColumnSubHeader = function (_h) {
                    var date = _h.date, locale = _h.locale;
                 ...
                 * @return {?}
                 */
                CalendarAngularDateFormatter.prototype.weekViewTitle = function (_h) {
                    var date = _h.date, locale = _h.locale, weekStartsOn = _h.weekStartsOn, excludeDays = _h.excludeDays, daysInWeek = _h.daysInWeek;
                    var _j = getWeekViewPeriod(this.dateAdapter, date, weekStartsOn, excludeDays, daysInWeek), viewStart = _j.viewStart, viewEnd = _j.viewEnd;
                    /** @type {?} */
                    var format = ( /**
                     * @param {?} dateToFormat
                     * @param {?} showYear
                     * @return {?}
                     */function (dateToFormat, showYear) { return Object(_angular_common__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(dateToFormat, 'MMM d' + (showYear ? ', yyyy' : ''), locale); });
                 ...
                 * @return {?}
                 */
                CalendarAngularDateFormatter.prototype.weekViewHour = function (_h) {
                    var date = _h.date, locale = _h.locale;
                 ...
                 * @return {?}
                 */
                CalendarAngularDateFormatter.prototype.dayViewHour = function (_h) {
                    var date = _h.date, locale = _h.locale;
                    return Object(_angular_common__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(date, 'h a', locale);
                };
                /**
                 ...
                 * @return {?}
                 */
                CalendarAngularDateFormatter.prototype.dayViewTitle = function (_h) {
                    var date = _h.date, locale = _h.locale;
            ...
            var CalendarDatePipe = /** @class */ (function () {
                ...
                CalendarDatePipe.prototype.transform = function (date, method, locale, weekStartsOn, excludeDays, daysInWeek) {
                    ...
                    if (typeof this.dateFormatter[method] === 'undefined') {
                         ...
                         * @param {?} iMethod
                         * @return {?}
                         */ iMethod) { return iMethod !== 'constructor'; }));
            ...
            var CalendarMomentDateFormatter = /** @class */ (function () {
                 ...
                 * @return {?}
                 */
                CalendarMomentDateFormatter.prototype.monthViewColumnHeader = function (_h) {
                    var date = _h.date, locale = _h.locale;
                 ...
                 * @return {?}
                 */
                CalendarMomentDateFormatter.prototype.monthViewDayNumber = function (_h) {
                    var date = _h.date, locale = _h.locale;
                    return this.moment(date)
                        .locale(locale)
                        .format('D');
                 ...
                 * @return {?}
                 */
                CalendarMomentDateFormatter.prototype.monthViewTitle = function (_h) {
                    var date = _h.date, locale = _h.locale;
                    return this.moment(date)
                        .locale(locale)
                        .format('MMMM YYYY');
                 ...
                 * @return {?}
                 */
                CalendarMomentDateFormatter.prototype.weekViewColumnHeader = function (_h) {
                    var date = _h.date, locale = _h.locale;
                    return this.moment(date)
                        .locale(locale)
                        .format('dddd');
                 ...
                 * @return {?}
                 */
                CalendarMomentDateFormatter.prototype.weekViewColumnSubHeader = function (_h) {
                    var date = _h.date, locale = _h.locale;
                    return this.moment(date)
                        .locale(locale)
                        .format('MMM D');
                 ...
                 * @return {?}
                 */
                CalendarMomentDateFormatter.prototype.weekViewTitle = function (_h) {
                    var _this = this;
                    var date = _h.date, locale = _h.locale, weekStartsOn = _h.weekStartsOn, excludeDays = _h.excludeDays, daysInWeek = _h.daysInWeek;
                    var _j = getWeekViewPeriod(this.dateAdapter, date, weekStartsOn, excludeDays, daysInWeek), viewStart = _j.viewStart, viewEnd = _j.viewEnd;
                    /** @type {?} */
                     ...
                     * @param {?} showYear
                     * @return {?}
                     */function (dateToFormat, showYear) { return _this.moment(dateToFormat)
                        .locale(locale)
                 ...
                 * @return {?}
                 */
                CalendarMomentDateFormatter.prototype.weekViewHour = function (_h) {
                    var date = _h.date, locale = _h.locale;
                    return this.moment(date)
                        .locale(locale)
                        .format('ha');
                 ...
                 * @return {?}
                 */
                CalendarMomentDateFormatter.prototype.dayViewHour = function (_h) {
                    var date = _h.date, locale = _h.locale;
                    return this.moment(date)
                        .locale(locale)
                        .format('ha');
                 ...
                 * @return {?}
                 */
                CalendarMomentDateFormatter.prototype.dayViewTitle = function (_h) {
                    var date = _h.date, locale = _h.locale;
                    return this.moment(date)
                        .locale(locale)
            ...
            var CalendarNativeDateFormatter = /** @class */ (function () {
                 ...
                 * @return {?}
                 */
                CalendarNativeDateFormatter.prototype.monthViewColumnHeader = function (_h) {
                    var date = _h.date, locale = _h.locale;
                 ...
                 * @return {?}
                 */
                CalendarNativeDateFormatter.prototype.monthViewDayNumber = function (_h) {
                    var date = _h.date, locale = _h.locale;
                 ...
                 * @return {?}
                 */
                CalendarNativeDateFormatter.prototype.monthViewTitle = function (_h) {
                    var date = _h.date, locale = _h.locale;
                 ...
                 * @return {?}
                 */
                CalendarNativeDateFormatter.prototype.weekViewColumnHeader = function (_h) {
                    var date = _h.date, locale = _h.locale;
                    return new Intl.DateTimeFormat(locale, { weekday: 'long' }).format(date);
                };
                /**
                 ...
                 * @return {?}
                 */
                CalendarNativeDateFormatter.prototype.weekViewColumnSubHeader = function (_h) {
                    var date = _h.date, locale = _h.locale;
                    return new Intl.DateTimeFormat(locale, {
                        day: 'numeric',
                        month: 'short'
                 ...
                 * @return {?}
                 */
                CalendarNativeDateFormatter.prototype.weekViewTitle = function (_h) {
                    var date = _h.date, locale = _h.locale, weekStartsOn = _h.weekStartsOn, excludeDays = _h.excludeDays, daysInWeek = _h.daysInWeek;
                    var _j = getWeekViewPeriod(this.dateAdapter, date, weekStartsOn, excludeDays, daysInWeek), viewStart = _j.viewStart, viewEnd = _j.viewEnd;
                    /** @type {?} */
                    var format = ( /**
                     ...
                     * @param {?} showYear
                     * @return {?}
                     */function (dateToFormat, showYear) { return new Intl.DateTimeFormat(locale, {
                        day: 'numeric',
                        month: 'short',
                 ...
                 * @return {?}
                 */
                CalendarNativeDateFormatter.prototype.weekViewHour = function (_h) {
                    var date = _h.date, locale = _h.locale;
                 ...
                 * @return {?}
                 */
                CalendarNativeDateFormatter.prototype.dayViewHour = function (_h) {
                    var date = _h.date, locale = _h.locale;
                    return new Intl.DateTimeFormat(locale, { hour: 'numeric' }).format(date);
                };
                /**
                 ...
                 * @return {?}
                 */
                CalendarNativeDateFormatter.prototype.dayViewTitle = function (_h) {
                    var date = _h.date, locale = _h.locale;
                    return new Intl.DateTimeFormat(locale, {
                        day: 'numeric',
                        month: 'long',
            ...
            var CalendarMonthViewComponent = /** @class */ (function () {
                ...
                function CalendarMonthViewComponent(cdr, utils, locale, dateAdapter) {
                     ...
                     * @param {?} offset
                     * @return {?}
                     */function (index, offset) { return _this.view.days
                 ...
                 * @param {?} day
                 * @return {?}
                 */ day) { return day.date.toISOString(); }))
                        .join('-'); });
                    /**
                     * @hidden
                     */
                ...
                CalendarMonthViewComponent.prototype.checkActiveDayIsOpen = function () {
                    ...
                    if (this.activeDayIsOpen === true) {
                         ...
                         * @param {?} day
                         * @return {?}
                         */ day) { return _this.dateAdapter.isSameDay(day.date, activeDay_1); }));
                        /** @type {?} */
            ...
            var CalendarDragHelper = /** @class */ (function () {
                 ...
                 * @return {?}
                 */
                CalendarDragHelper.prototype.validateDrag = function (_h) {
                    var x = _h.x, y = _h.y, snapDraggedEvents = _h.snapDraggedEvents, dragAlreadyMoved = _h.dragAlreadyMoved, transform = _h.transform;
            ...
            var CalendarResizeHelper = /** @class */ (function () {
                 ...
                 * @return {?}
                 */
                CalendarResizeHelper.prototype.validateResize = function (_h) {
                    var rectangle = _h.rectangle;
                    if (this.minWidth &&
            ...
            var CalendarWeekViewComponent = /** @class */ (function () {
                ...
                function CalendarWeekViewComponent(cdr, utils, locale, dateAdapter) {
                     ...
                     * @param {?} column
                     * @return {?}
                     */function (index, column) { return column.hours[0] ? column.hours[0].segments[0].date.toISOString() : column; });
                    /**
                     * @hidden
                     */
                    this.trackById = ( /**
                ...
                CalendarWeekViewComponent.prototype.dragStarted = function (eventsContainer, event, dayEvent) {
                     ...
                     * @return {?}
                     */function (_h) {
                        var x = _h.x, y = _h.y, transform = _h.transform;
                    ...
                    if (!this.snapDraggedEvents && dayEvent) {
                         ...
                         */ column) {
                             ...
                             * @param {?} columnEvent
                             * @return {?}
                             */ columnEvent) { return columnEvent.event === dayEvent.event && columnEvent !== dayEvent; }));
                ...
                CalendarWeekViewComponent.prototype.dragMove = function (dayEvent, dragEvent) {
                    if (this.snapDraggedEvents) {
                        ...
                        /** @type {?} */
                        var adjustedEvent_1 = Object.assign({}, originalEvent_1, newEventTimes);
                        /** @type {?} */
                ...
                CalendarWeekViewComponent.prototype.dragEnded = function (weekEvent, dragEndEvent, dayWidth, useY) {
                    ...
                    this.view = this.getWeekView(this.events);
                    this.dragActive = false;
                    var _h = this.getDragMovedEventTimes(weekEvent, dragEndEvent, dayWidth, useY), start = _h.start, end = _h.end;
                ...
                CalendarWeekViewComponent.prototype.getWeekView = function (events) {
                    return this.utils.getWeekView(Object.assign({ events: events, viewDate: this.viewDate, weekStartsOn: this.weekStartsOn, excluded: this.excludeDays, precision: this.precision, absolutePositionedEvents: true, hourSegments: this.hourSegments, dayStart: {
                ...
                CalendarWeekViewComponent.prototype.restoreOriginalEvents = function (tempEvents, adjustedEvents) {
                     ...
                     * @param {?} event
                     * @return {?}
                     */ event) { return adjustedEvents.has(event); }));
                    this.view.hourColumns.forEach(( /**
                     * @param {?} column
                     * @param {?} columnIndex
                     * @return {?}
                     */function (column, columnIndex) {
                         ...
                         */ adjustedEvent) {
                             ...
                             * @param {?} columnEvent
                             * @return {?}
                             */ columnEvent) { return columnEvent.event === adjustedEvent; }));
            ...
            var CalendarDayViewComponent = /** @class */ (function () {
                 ...
                 * @return {?}
                 */
                CalendarDayViewComponent.prototype.dragStarted = function (event, dayEventsContainer, dayEvent) {
                    var _this = this;
                    /** @type {?} */
                 ...
                 * @return {?}
                 */
                CalendarDayViewComponent.prototype.dragMove = function (coords) {
                    this.dragAlreadyMoved = true;
                    if (this.snapDraggedEvents) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DraggableScrollContainerDirective = /** @class */ (function () {
                 ...
                 * @return {?}
                 */
                DraggableScrollContainerDirective.prototype.ngOnInit = function () {
                    var _this = this;
                 ...
                 * @return {?}
                 */
                DraggableScrollContainerDirective.prototype.disableScroll = function () {
                 ...
                 * @return {?}
                 */
                DraggableScrollContainerDirective.prototype.enableScroll = function () {
                    this.cancelledScroll = false;
                 ...
                 * @return {?}
                 */
                DraggableScrollContainerDirective.prototype.hasScrollbar = function () {
                    /** @type {?} */
            ...
            var DraggableDirective = /** @class */ (function () {
                ...
                DraggableDirective.prototype.ngOnInit = function () {
                    ...
                    /** @type {?} */
                    var pointerDragged$ = this.pointerDown$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(function () { return _this.canDrag(); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["mergeMap"])(function (pointerDownEvent) {
                        ...
                        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["startWith"])(startScrollPosition), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function () { return _this.getScrollPosition(); }));
                        /** @type {?} */
                        ...
                        /** @type {?} */
                        var dragComplete$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["merge"])(_this.pointerUp$, _this.pointerDown$, cancelDrag$, _this.destroy$).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["share"])());
                        /** @type {?} */
                        var pointerMove = Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["combineLatest"])(_this.pointerMove$, scrollContainerScroll$).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (_h) {
                            var pointerMoveEvent = _h[0], scroll = _h[1];
                            return {
                        ...
                        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(function (_h) {
                            var x = _h.x, y = _h.y, transformX = _h.transformX, transformY = _h.transformY;
                        ...
                        dragStarted$.subscribe(function (_h) {
                            var clientX = _h.clientX, clientY = _h.clientY, x = _h.x, y = _h.y;
                            _this.zone.run(function () {
                                _this.dragStart.next({ cancelDrag$: cancelDrag$ });
                            });
                            _this.scroller = dom_autoscroller__WEBPACK_IMPORTED_MODULE_4___default()([
                        ...
                        dragEnded$
                            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["mergeMap"])(function (dragEndData) {
                            /** @type {?} */
                            var dragEndData$ = cancelDrag$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["count"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (calledCount) { return (Object.assign({}, dragEndData, { dragCancelled: calledCount > 0 })); }));
                            cancelDrag$.complete();
                            return dragEndData$;
                        }))
                            .subscribe(function (_h) {
                            var x = _h.x, y = _h.y, dragCancelled = _h.dragCancelled;
                    ...
                    Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["merge"])(pointerDragged$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (value) { return [, value]; })), pointerDragged$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["pairwise"])()))
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(function (_h) {
                        var previous = _h[0], next = _h[1];
                        if (!previous) {
                            return true;
                        }
                        return previous.x !== next.x || previous.y !== next.y;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (_h) {
                        var previous = _h[0], next = _h[1];
                        return next;
                    }))
                        .subscribe(function (_h) {
                        var x = _h.x, y = _h.y, currentDrag$ = _h.currentDrag$, clientX = _h.clientX, clientY = _h.clientY, transformX = _h.transformX, transformY = _h.transformY;
                        _this.zone.run(function () {
            ...
            var DroppableDirective = /** @class */ (function () {
                ...
                DroppableDirective.prototype.ngOnInit = function () {
                    ...
                    this.currentDragSubscription = this.draggableHelper.currentDrag.subscribe(function (drag$) {
                        ...
                        /** @type {?} */
                        var overlaps$ = drag$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (_h) {
                            var clientX = _h.clientX, clientY = _h.clientY, dropData = _h.dropData;
                        ...
                        overlapsChanged$
                            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(function (overlapsNow) { return overlapsNow; }))
                            .subscribe(function () {
                            dragOverActive = true;
                        ...
                        overlaps$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(function (overlapsNow) { return overlapsNow; })).subscribe(function () {
                            _this.zone.run(function () {
                                _this.dragOver.next({
                                    dropData: currentDragDropData
                                });
                        ...
                        overlapsChanged$
                            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["pairwise"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(function (_h) {
                            var didOverlap = _h[0], overlapsNow = _h[1];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
             ...
             * @return {?}
             */
            function isWithinBoundingY(_h) {
                var clientY = _h.clientY, rect = _h.rect;
             ...
             * @return {?}
             */
            function isWithinBoundingX(_h) {
                var clientX = _h.clientX, rect = _h.rect;
             ...
             * @return {?}
             */
            function getResizeEdges(_h) {
                var clientX = _h.clientX, clientY = _h.clientY, elm = _h.elm, allowedEdges = _h.allowedEdges, cursorPrecision = _h.cursorPrecision;
                /** @type {?} */
             ...
             * @return {?}
             */
            function getEdgesDiff(_h) {
                var edges = _h.edges, initialRectangle = _h.initialRectangle, newRectangle = _h.newRectangle;
                /** @type {?} */
                var edgesDiff = {};
            ...
            var ResizableDirective = /** @class */ (function () {
                ...
                ResizableDirective.prototype.ngOnInit = function () {
                    ...
                    this.pointerEventListeners.pointerDown
                        ...
                        .subscribe(function (_h) {
                        var clientX = _h.clientX, clientY = _h.clientY;
                        _this.mousedown.next({ clientX: clientX, clientY: clientY });
                    });
                    this.pointerEventListeners.pointerMove
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(this.destroy$))
                        .subscribe(function (_h) {
                        var clientX = _h.clientX, clientY = _h.clientY, event = _h.event;
                    ...
                    mouseMove.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(function () { return !!currentResize; })).subscribe(function (_h) {
                        var event = _h.event;
                        event.preventDefault();
                    });
                    this.resizeEdges$
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["startWith"])(this.resizeEdges), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function () {
                        return (_this.resizeEdges &&
                            Object.keys(_this.resizeEdges).some(function (edge) { return !!_this.resizeEdges[edge]; }));
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(function (legacyResizeEdgesEnabled) { return legacyResizeEdgesEnabled ? mouseMove : rxjs__WEBPACK_IMPORTED_MODULE_1__["EMPTY"]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["auditTime"])(MOUSE_MOVE_THROTTLE_MS))
                        .subscribe(function (_h) {
                        var clientX = _h.clientX, clientY = _h.clientY;
                        /** @type {?} */
                    ...
                    var mousedrag = this.mousedown
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["mergeMap"])(function (startCoords) {
                        /**
                         * @param {?} moveCoords
                         * @return {?}
                         */
                        ...
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["merge"])(mouseMove.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["take"])(1)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (coords) { return [, coords]; })), mouseMove.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["pairwise"])()))
                            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (_h) {
                            var previousCoords = _h[0], newCoords = _h[1];
                            return [
                            ...
                            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["merge"])(_this.mouseup, _this.mousedown)));
                    }))
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(function () { return !!currentResize; }));
                    mousedrag
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (_h) {
                        var clientX = _h.clientX, clientY = _h.clientY;
                    ...
                    this.mousedown
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (_h) {
                        var clientX = _h.clientX, clientY = _h.clientY, edges = _h.edges;
                        return (edges ||
                            getResizeEdges({
                                clientX: clientX,
                                clientY: clientY,
                 ...
                 * @return {?}
                 */
                ResizableDirective.prototype.ngOnChanges = function (changes) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var PageLayoutContentDirective = /** @class */ (function () {
                function PageLayoutContentDirective() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var PageLayoutHeaderDirective = /** @class */ (function () {
                function PageLayoutHeaderDirective() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PageLayoutComponent = /** @class */ (function () {
                ...
                Object.defineProperty(PageLayoutComponent.prototype, "isCard", {
                    get: function () {
                ...
                Object.defineProperty(PageLayoutComponent.prototype, "isSimple", {
                    get: function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CalendarComponent = /** @class */ (function () {
                ...
                CalendarComponent.prototype.dayClicked = function (_h) {
                    var date = _h.date, events = _h.events;
                ...
                CalendarComponent.prototype.eventTimesChanged = function (_h) {
                    var event = _h.event, newStart = _h.newStart, newEnd = _h.newEnd;
                ...
                CalendarComponent.prototype.handleEvent = function (action, event) {
                    ...
                    dialogRef.afterClosed().subscribe(function (result) {
                        if (result) {
                            event = result;
                            _this.snackbar.open('Updated Event: ' + event.title);
                            _this.refresh.next();
                        }
                    });
                };
