...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var dropdownAnimation = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["trigger"])('dropdown', [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_animations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/animations */ "./node_modules/@angular/animations/fesm2015/animations.js");
            var popoverAnimation = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["trigger"])('transformPopover', [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MegaMenuComponent = /** @class */ (function () {
                ...
                MegaMenuComponent.prototype.close = function () {
                    this.popoverRef.close();
                };
                return MegaMenuComponent;
            }());
            MegaMenuComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NavigationItemComponent = /** @class */ (function () {
                function NavigationItemComponent(navigationService, router) {
                    ...
                    this.router = router;
                    this.isActive$ = this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationEnd"]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["startWith"])(null), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function () { return function (item) { return _this.hasActiveChilds(item); }; }));
                ...
                NavigationItemComponent.prototype.hasActiveChilds = function (parent) {
                    var _this = this;
                    ...
                    if (this.isDropdown(parent) || this.isSubheading(parent)) {
                        return parent.children.some(function (child) {
                            if (_this.isDropdown(child)) {
                                return _this.hasActiveChilds(child);
                            }
                            if (_this.isLink(child) && !_this.isFunction(child.route)) {
                                return _this.router.isActive(child.route, false);
                            }
                        });
                    }
                    return false;
                };
                NavigationItemComponent.prototype.isFunction = function (prop) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NavigationItemModule = /** @class */ (function () {
                function NavigationItemModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PopoverService = /** @class */ (function () {
                ...
                PopoverService.prototype.open = function (_a) {
                    var origin = _a.origin, content = _a.content, data = _a.data, width = _a.width, height = _a.height, position = _a.position, offsetX = _a.offsetX, offsetY = _a.offsetY;
                    var overlayRef = this.overlay.create(this.getOverlayConfig({ origin: origin, width: width, height: height, position: position, offsetX: offsetX, offsetY: offsetY }));
                ...
                PopoverService.prototype.getOverlayConfig = function (_a) {
                    var origin = _a.origin, width = _a.width, height = _a.height, position = _a.position, offsetX = _a.offsetX, offsetY = _a.offsetY;
                    return new _angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_2__["OverlayConfig"]({
                        hasBackdrop: true,
                        width: width,
                        height: height,
                        backdropClass: 'popover-backdrop',
                        positionStrategy: this.getOverlayPosition({ origin: origin, position: position, offsetX: offsetX, offsetY: offsetY }),
                        scrollStrategy: this.overlay.scrollStrategies.reposition()
                    });
                };
                PopoverService.prototype.getOverlayPosition = function (_a) {
                    var origin = _a.origin, position = _a.position, offsetX = _a.offsetX, offsetY = _a.offsetY;
            ...
            var ScrollbarDirective = /** @class */ (function () {
                ...
                ScrollbarDirective.prototype.ngAfterContentInit = function () {
                    ...
                    this.zone.runOutsideAngular(function () {
                        _this.scrollbarRef = new simplebar__WEBPACK_IMPORTED_MODULE_2__["default"](_this._element.nativeElement, _this.options);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchComponent = /** @class */ (function () {
                ...
                SearchComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.show$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (show) { return show; }), Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_4__["untilDestroyed"])(this)).subscribe(function () { return _this.input.nativeElement.focus(); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SidebarComponent = /** @class */ (function () {
                ...
                Object.defineProperty(SidebarComponent.prototype, "positionLeft", {
                    get: function () {
                ...
                Object.defineProperty(SidebarComponent.prototype, "positionRight", {
                    get: function () {
                ...
                SidebarComponent.prototype.enableScrollblock = function () {
                    if (!this.document.body.classList.contains('vex-scrollblock')) {
                        this.document.body.classList.add('vex-scrollblock');
                    }
                };
                SidebarComponent.prototype.disableScrollblock = function () {
                    if (this.document.body.classList.contains('vex-scrollblock')) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SidenavItemComponent = /** @class */ (function () {
                ...
                SidenavItemComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationEnd"]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function () { return _this.isDropdown(_this.item); }), Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_4__["untilDestroyed"])(this)).subscribe(function () { return _this.onRouteChange(); });
                    this.navigationService.openChange$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function () { return _this.isDropdown(_this.item); }), Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_4__["untilDestroyed"])(this)).subscribe(function (item) { return _this.onOpenChange(item); });
                };
                SidenavItemComponent.prototype.ngOnChanges = function (changes) {
                    if (changes && changes.hasOwnProperty('item') && this.isDropdown(this.item)) {
                        this.onRouteChange();
                    }
                };
                SidenavItemComponent.prototype.toggleOpen = function () {
                    this.isOpen = !this.isOpen;
                    this.navigationService.triggerOpenChange(this.item);
                    this.cd.markForCheck();
                };
                SidenavItemComponent.prototype.onOpenChange = function (item) {
                ...
                SidenavItemComponent.prototype.onRouteChange = function () {
                    if (this.hasActiveChilds(this.item)) {
                        this.isActive = true;
                        this.isOpen = true;
                        this.navigationService.triggerOpenChange(this.item);
                ...
                SidenavItemComponent.prototype.isChildrenOf = function (parent, item) {
                    var _this = this;
                    if (parent.children.indexOf(item) !== -1) {
                        return true;
                    }
                    return parent.children
                        .filter(function (child) { return _this.isDropdown(child); })
                        .some(function (child) { return _this.isChildrenOf(child, item); });
                };
                SidenavItemComponent.prototype.hasActiveChilds = function (parent) {
                    var _this = this;
                    return parent.children.some(function (child) {
                        if (_this.isDropdown(child)) {
                            return _this.hasActiveChilds(child);
                ...
                SidenavItemComponent.prototype.isFunction = function (prop) {
                    return prop instanceof Function;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SidenavItemModule = /** @class */ (function () {
                function SidenavItemModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToolbarNotificationsDropdownComponent = /** @class */ (function () {
                ...
                ToolbarNotificationsDropdownComponent.prototype.ngOnInit = function () {
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToolbarNotificationsComponent = /** @class */ (function () {
                ...
                ToolbarNotificationsComponent.prototype.showPopover = function () {
                    var _this = this;
            ...
            ToolbarNotificationsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToolbarNotificationsModule = /** @class */ (function () {
                function ToolbarNotificationsModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToolbarUserDropdownComponent = /** @class */ (function () {
                ...
                ToolbarUserDropdownComponent.prototype.ngOnInit = function () {
                };
                ToolbarUserDropdownComponent.prototype.setStatus = function (status) {
                    this.activeStatus = status;
                    this.cd.markForCheck();
                };
                ToolbarUserDropdownComponent.prototype.close = function () {
                    this.popoverRef.close();
                };
                return ToolbarUserDropdownComponent;
            }());
            ToolbarUserDropdownComponent.ctorParameters = function () { return [
                { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToolbarUserComponent = /** @class */ (function () {
                ...
                ToolbarUserComponent.prototype.showPopover = function (originRef) {
                    var _this = this;
                    this.dropdownOpen = true;
                    this.cd.markForCheck();
                    var popoverRef = this.popover.open({
            ...
            ToolbarUserComponent.ctorParameters = function () { return [
                { type: _popover_popover_service__WEBPACK_IMPORTED_MODULE_2__["PopoverService"] },
                { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToolbarUserModule = /** @class */ (function () {
                function ToolbarUserModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContainerDirective = /** @class */ (function () {
                function ContainerDirective(configService, cd) {
                    ...
                    this.cd = cd;
                    this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (config) { return config.boxed; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(), Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_4__["untilDestroyed"])(this)).subscribe(function (boxed) {
                        _this.enabled = boxed;
                        _this.cd.markForCheck();
                    });
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LayoutComponent = /** @class */ (function () {
                function LayoutComponent(cd, breakpointObserver, layoutService, configService, router, document) {
                    ...
                    this.router = router;
                    this.document = document;
                    this.isLayoutVertical$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (config) { return config.layout === 'vertical'; }));
                    this.isBoxed$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (config) { return config.boxed; }));
                    this.isToolbarFixed$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (config) { return config.toolbar.fixed; }));
                    this.isFooterFixed$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (config) { return config.footer.fixed; }));
                    this.isFooterVisible$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (config) { return config.footer.visible; }));
                    this.sidenavCollapsed$ = this.layoutService.sidenavCollapsed$;
                    this.isDesktop$ = this.breakpointObserver.observe("(min-width: " + _utils_tailwindcss__WEBPACK_IMPORTED_MODULE_11__["default"].screens.lg + ")").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (state) { return state.matches; }));
                    this.toolbarShadowEnabled$ = this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_6__["NavigationEnd"]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["startWith"])(null), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function () { return Object(_utils_check_router_childs_data__WEBPACK_IMPORTED_MODULE_8__["checkRouterChildsData"])(_this.router.routerState.root.snapshot, function (data) { return data.toolbarShadowEnabled; }); }));
                    this.scrollDisabled$ = this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_6__["NavigationEnd"]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["startWith"])(null), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function () { return Object(_utils_check_router_childs_data__WEBPACK_IMPORTED_MODULE_8__["checkRouterChildsData"])(_this.router.routerState.root.snapshot, function (data) { return data.scrollDisabled; }); }));
                    this.containerEnabled$ = this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_6__["NavigationEnd"]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["startWith"])(null), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function () { return Object(_utils_check_router_childs_data__WEBPACK_IMPORTED_MODULE_8__["checkRouterChildsData"])(_this.router.routerState.root.snapshot, function (data) { return data.containerEnabled; }); }));
                    this.searchOpen$ = this.layoutService.searchOpen$;
                }
                LayoutComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.isDesktop$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["filter"])(function (matches) { return !matches; }), Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_4__["untilDestroyed"])(this)).subscribe(function () { return _this.layoutService.expandSidenav(); });
                    this.layoutService.sidenavOpen$.pipe(Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_4__["untilDestroyed"])(this)).subscribe(function (open) { return open ? _this.sidenav.open() : _this.sidenav.close(); });
                    this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_6__["NavigationEnd"]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["withLatestFrom"])(this.isDesktop$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["filter"])(function (_a) {
                        var event = _a[0], matches = _a[1];
                        return !matches;
                    }), Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_4__["untilDestroyed"])(this)).subscribe(function () { return _this.sidenav.close(); });
                };
                LayoutComponent.prototype.ngAfterViewInit = function () {
                    var _this = this;
                    this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["filter"])(function (e) { return e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_6__["Scroll"]; }), Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_4__["untilDestroyed"])(this)).subscribe(function (e) {
                        if (e.position) {
                            // backward navigation
                            _this.sidenavContainer.scrollable.scrollTo({
                                start: e.position[0],
                                top: e.position[1]
                            });
                        }
                            ...
                            // anchor navigation
                            var scroll_1 = function (anchor) { return _this.sidenavContainer.scrollable.scrollTo({
                                behavior: 'smooth',
                                top: anchor.offsetTop,
                                left: anchor.offsetLeft
                            }); };
                            var anchorElem_1 = _this.document.getElementById(e.anchor);
                            if (anchorElem_1) {
                                scroll_1(anchorElem_1);
                            }
                            else {
                                setTimeout(function () {
                                    anchorElem_1 = _this.document.getElementById(e.anchor);
                                    scroll_1(anchorElem_1);
                                }, 100);
                            }
                        }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToolbarComponent = /** @class */ (function () {
                function ToolbarComponent(layoutService, configService, navigationService, popoverService) {
                    ...
                    this.isHorizontalLayout$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(function (config) { return config.layout === 'horizontal'; }));
                    this.isVerticalLayout$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(function (config) { return config.layout === 'vertical'; }));
                    this.isNavbarInToolbar$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(function (config) { return config.navbar.position === 'in-toolbar'; }));
                    this.isNavbarBelowToolbar$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(function (config) { return config.navbar.position === 'below-toolbar'; }));
                ...
                ToolbarComponent.prototype.openQuickpanel = function () {
                    this.layoutService.openQuickpanel();
                };
                ToolbarComponent.prototype.openSidenav = function () {
                    this.layoutService.openSidenav();
                };
                ToolbarComponent.prototype.openMegaMenu = function (origin) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ColorFadeModule = /** @class */ (function () {
                function ColorFadeModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ColorFadePipe = /** @class */ (function () {
                function ColorFadePipe() {
                }
                ColorFadePipe.prototype.transform = function (value, ratio) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RelativeDateTimeModule = /** @class */ (function () {
                function RelativeDateTimeModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var RelativeDateTimePipe = /** @class */ (function () {
                function RelativeDateTimePipe() {
                }
                RelativeDateTimePipe.prototype.transform = function (value) {
                    var args = [];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ConfigService = /** @class */ (function () {
                function ConfigService(document, layoutService) {
                    ...
                    this._configSubject = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"](this.configs.find(function (c) { return c.id === _this.defaultConfig; }));
                    this.config$ = this._configSubject.asObservable();
                    this.config$.subscribe(function (config) { return _this._updateConfig(config); });
                }
                ConfigService.prototype.setConfig = function (config) {
                    var settings = this.configs.find(function (c) { return c.id === config; });
                    if (settings) {
                ...
                ConfigService.prototype._updateConfig = function (config) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LayoutService = /** @class */ (function () {
                ...
                LayoutService.prototype.openQuickpanel = function () {
                    this._quickpanelOpenSubject.next(true);
                };
                LayoutService.prototype.closeQuickpanel = function () {
                    this._quickpanelOpenSubject.next(false);
                };
                LayoutService.prototype.openSidenav = function () {
                    this._sidenavOpenSubject.next(true);
                };
                LayoutService.prototype.closeSidenav = function () {
                    this._sidenavOpenSubject.next(false);
                };
                LayoutService.prototype.collapseSidenav = function () {
                    this._sidenavCollapsedSubject.next(true);
                };
                LayoutService.prototype.expandSidenav = function () {
                    this._sidenavCollapsedSubject.next(false);
                };
                LayoutService.prototype.collapseOpenSidenav = function () {
                    this._sidenavCollapsedOpenSubject.next(true);
                };
                LayoutService.prototype.collapseCloseSidenav = function () {
                    this._sidenavCollapsedOpenSubject.next(false);
                };
                LayoutService.prototype.openConfigpanel = function () {
                    this._configpanelOpenSubject.next(true);
                };
                LayoutService.prototype.closeConfigpanel = function () {
                    this._configpanelOpenSubject.next(false);
                };
                LayoutService.prototype.openSearch = function () {
                    this._searchOpen.next(true);
                };
                LayoutService.prototype.closeSearch = function () {
                    this._searchOpen.next(false);
                };
                LayoutService.prototype.enableRTL = function () {
                ...
                LayoutService.prototype.disableRTL = function () {
                    this.router.navigate([], {
                        queryParams: {
                            rtl: 'false'
                        }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NavigationService = /** @class */ (function () {
                ...
                NavigationService.prototype.triggerOpenChange = function (item) {
                    this._openChangeSubject.next(item);
                };
                NavigationService.prototype.isLink = function (item) {
                    return item.type === 'link';
                };
                NavigationService.prototype.isDropdown = function (item) {
                    return item.type === 'dropdown';
                };
                NavigationService.prototype.isSubheading = function (item) {
            ...
            var SplashScreenService = /** @class */ (function () {
                function SplashScreenService(router, document, animationBuilder) {
                    ...
                    if (this.splashScreenElem) {
                        this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1)).subscribe(function () { return _this.hide(); });
                    }
                }
                SplashScreenService.prototype.hide = function () {
                    ...
                    player.onDone(function () { return _this.splashScreenElem.remove(); });
                    player.play();
                };
                return SplashScreenService;
            }());
            SplashScreenService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StyleService = /** @class */ (function () {
                function StyleService(document) {
                    ...
                    this.style$.pipe(Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_4__["untilDestroyed"])(this)).subscribe(function (style) { return _this._updateStyle(style); });
                }
                StyleService.prototype.setStyle = function (style) {
                    this._styleSubject.next(style);
                };
                StyleService.prototype.ngOnDestroy = function () { };
                StyleService.prototype._updateStyle = function (style) {
                    var body = this.document.body;
                    Object.values(Style).filter(function (s) { return s !== style; }).forEach(function (value) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var childrenRoutes = [
                ...
                },
                {
                    ...
                    children: [
                        {
                            path: "contacts",
                            loadChildren: function () { return __webpack_require__.e(/*! import() | pages-apps-contacts-contacts-module */ "pages-apps-contacts-contacts-module").then(__webpack_require__.bind(null, /*! ./pages/apps/contacts/contacts.module */ "./src/app/pages/apps/contacts/contacts.module.ts")).then(function (m) { return m.ContactsModule; }); },
                        },
                        {
                            path: "calendar",
                            loadChildren: function () { return Promise.all(/*! import() | pages-apps-calendar-calendar-module */ [__webpack_require__.e("default~components-dialogs-components-dialogs-module~components-overview-components-overview-module~~e8ad5f8f"), __webpack_require__.e("default~components-overview-components-overview-module~components-snack-bar-components-snack-bar-mod~caef03c6"), __webpack_require__.e("default~contacts-table-contacts-table-module~pages-apps-calendar-calendar-module~pages-apps-clientes~ea910b37"), __webpack_require__.e("common"), __webpack_require__.e("pages-apps-calendar-calendar-module")]).then(__webpack_require__.bind(null, /*! ./pages/apps/calendar/calendar.module */ "./src/app/pages/apps/calendar/calendar.module.ts")).then(function (m) { return m.CalendarModule; }); },
                            data: {
                        ...
                        {
                            path: "clientes",
                            loadChildren: function () { return Promise.all(/*! import() | pages-apps-clientes-aio-table-module */ [__webpack_require__.e("default~components-checkbox-components-checkbox-module~components-overview-components-overview-modul~2bad73dc"), __webpack_require__.e("default~components-dialogs-components-dialogs-module~components-overview-components-overview-module~~e8ad5f8f"), __webpack_require__.e("default~components-overview-components-overview-module~components-snack-bar-components-snack-bar-mod~caef03c6"), __webpack_require__.e("default~components-button-group-components-button-group-module~components-buttons-components-buttons~471913aa"), __webpack_require__.e("default~contacts-table-contacts-table-module~pages-apps-calendar-calendar-module~pages-apps-clientes~ea910b37"), __webpack_require__.e("default~contacts-table-contacts-table-module~pages-apps-clientes-aio-table-module~pages-apps-contrat~601e5afe"), __webpack_require__.e("default~components-autocomplete-components-autocomplete-module~components-overview-components-overvi~9739c1c8"), __webpack_require__.e("default~components-overview-components-overview-module~components-slider-components-slider-module~pa~b589e09d"), __webpack_require__.e("default~components-overview-components-overview-module~components-radio-components-radio-module~page~2454e66f"), __webpack_require__.e("default~components-overview-components-overview-module~components-slide-toggle-components-slide-togg~a0b60a3e"), __webpack_require__.e("default~components-grid-list-components-grid-list-module~components-overview-components-overview-mod~fa6c178b"), __webpack_require__.e("default~components-overview-components-overview-module~components-progress-spinner-components-progre~92b3aede"), __webpack_require__.e("default~components-cards-components-cards-module~components-overview-components-overview-module~page~9c85ba8d"), __webpack_require__.e("default~contacts-table-contacts-table-module~pages-apps-clientes-aio-table-module~pages-apps-contrat~d964ba47"), __webpack_require__.e("default~pages-apps-clientes-aio-table-module~pages-apps-contratos-contratos-module~pages-dashboards-~fab076b6"), __webpack_require__.e("default~pages-apps-clientes-aio-table-module~pages-apps-contratos-contratos-module~pages-dashboards-~dae42f44"), __webpack_require__.e("common"), __webpack_require__.e("pages-apps-clientes-aio-table-module")]).then(__webpack_require__.bind(null, /*! ./pages/apps/clientes/aio-table.module */ "./src/app/pages/apps/clientes/aio-table.module.ts")).then(function (m) { return m.AioTableModule; }); },
                        },
                        {
                            path: "contratos",
                            loadChildren: function () { return Promise.all(/*! import() | pages-apps-contratos-contratos-module */ [__webpack_require__.e("default~components-autocomplete-components-autocomplete-module~components-button-group-components-bu~319c71e2"), __webpack_require__.e("default~components-checkbox-components-checkbox-module~components-overview-components-overview-modul~2bad73dc"), __webpack_require__.e("default~components-dialogs-components-dialogs-module~components-overview-components-overview-module~~e8ad5f8f"), __webpack_require__.e("default~components-overview-components-overview-module~components-snack-bar-components-snack-bar-mod~caef03c6"), __webpack_require__.e("default~components-button-group-components-button-group-module~components-buttons-components-buttons~471913aa"), __webpack_require__.e("default~contacts-table-contacts-table-module~pages-apps-calendar-calendar-module~pages-apps-clientes~ea910b37"), __webpack_require__.e("default~contacts-table-contacts-table-module~pages-apps-clientes-aio-table-module~pages-apps-contrat~601e5afe"), __webpack_require__.e("default~components-autocomplete-components-autocomplete-module~components-overview-components-overvi~9739c1c8"), __webpack_require__.e("default~components-overview-components-overview-module~components-slider-components-slider-module~pa~b589e09d"), __webpack_require__.e("default~components-overview-components-overview-module~components-radio-components-radio-module~page~2454e66f"), __webpack_require__.e("default~components-overview-components-overview-module~components-slide-toggle-components-slide-togg~a0b60a3e"), __webpack_require__.e("default~components-grid-list-components-grid-list-module~components-overview-components-overview-mod~fa6c178b"), __webpack_require__.e("default~components-overview-components-overview-module~components-progress-spinner-components-progre~92b3aede"), __webpack_require__.e("default~components-cards-components-cards-module~components-overview-components-overview-module~page~9c85ba8d"), __webpack_require__.e("default~contacts-table-contacts-table-module~pages-apps-clientes-aio-table-module~pages-apps-contrat~d964ba47"), __webpack_require__.e("default~pages-apps-clientes-aio-table-module~pages-apps-contratos-contratos-module~pages-dashboards-~fab076b6"), __webpack_require__.e("default~pages-apps-clientes-aio-table-module~pages-apps-contratos-contratos-module~pages-dashboards-~dae42f44"), __webpack_require__.e("common"), __webpack_require__.e("pages-apps-contratos-contratos-module")]).then(__webpack_require__.bind(null, /*! ./pages/apps/contratos/contratos.module */ "./src/app/pages/apps/contratos/contratos.module.ts")).then(function (m) { return m.ContratosModule; }); },
                        }
                    ],
                },
                {
                    ...
                    children: [
                        {
                            path: "pricing",
                            loadChildren: function () { return Promise.all(/*! import() | pages-pages-pricing-pricing-module */ [__webpack_require__.e("common"), __webpack_require__.e("pages-pages-pricing-pricing-module")]).then(__webpack_require__.bind(null, /*! ./pages/pages/pricing/pricing.module */ "./src/app/pages/pages/pricing/pricing.module.ts")).then(function (m) { return m.PricingModule; }); },
                        },
                        {
                            path: "profile",
                            loadChildren: function () { return Promise.all(/*! import() | pages-pages-profile-profile-module */ [__webpack_require__.e("common"), __webpack_require__.e("pages-pages-profile-profile-module")]).then(__webpack_require__.bind(null, /*! ./pages/pages/profile/profile.module */ "./src/app/pages/pages/profile/profile.module.ts")).then(function (m) { return m.ProfileModule; }); },
                        },
                        {
                            path: "invoice",
                            loadChildren: function () { return Promise.all(/*! import() | pages-pages-invoice-invoice-module */ [__webpack_require__.e("common"), __webpack_require__.e("pages-pages-invoice-invoice-module")]).then(__webpack_require__.bind(null, /*! ./pages/pages/invoice/invoice.module */ "./src/app/pages/pages/invoice/invoice.module.ts")).then(function (m) { return m.InvoiceModule; }); },
                        },
                        {
                            path: "error-404",
                            loadChildren: function () { return __webpack_require__.e(/*! import() | pages-pages-errors-error-404-error-404-module */ "pages-pages-errors-error-404-error-404-module").then(__webpack_require__.bind(null, /*! ./pages/pages/errors/error-404/error-404.module */ "./src/app/pages/pages/errors/error-404/error-404.module.ts")).then(function (m) { return m.Error404Module; }); },
                        },
                        {
                            path: "error-500",
                            loadChildren: function () { return __webpack_require__.e(/*! import() | pages-pages-errors-error-500-error-500-module */ "pages-pages-errors-error-500-error-500-module").then(__webpack_require__.bind(null, /*! ./pages/pages/errors/error-500/error-500.module */ "./src/app/pages/pages/errors/error-500/error-500.module.ts")).then(function (m) { return m.Error500Module; }); },
                        },
                    ],
                },
                {
                    ...
                    children: [
                        {
                            path: "components",
                            loadChildren: function () { return __webpack_require__.e(/*! import() | pages-ui-components-components-module */ "pages-ui-components-components-module").then(__webpack_require__.bind(null, /*! ./pages/ui/components/components.module */ "./src/app/pages/ui/components/components.module.ts")).then(function (m) { return m.ComponentsModule; }); },
                        },
                        {
                            path: "forms/form-elements",
                            loadChildren: function () { return Promise.all(/*! import() | pages-ui-forms-form-elements-form-elements-module */ [__webpack_require__.e("default~components-checkbox-components-checkbox-module~components-overview-components-overview-modul~2bad73dc"), __webpack_require__.e("default~components-dialogs-components-dialogs-module~components-overview-components-overview-module~~e8ad5f8f"), __webpack_require__.e("default~contacts-table-contacts-table-module~pages-apps-calendar-calendar-module~pages-apps-clientes~ea910b37"), __webpack_require__.e("default~contacts-table-contacts-table-module~pages-apps-clientes-aio-table-module~pages-apps-contrat~601e5afe"), __webpack_require__.e("default~components-autocomplete-components-autocomplete-module~components-overview-components-overvi~9739c1c8"), __webpack_require__.e("default~components-overview-components-overview-module~components-slider-components-slider-module~pa~b589e09d"), __webpack_require__.e("default~components-overview-components-overview-module~components-radio-components-radio-module~page~2454e66f"), __webpack_require__.e("default~components-overview-components-overview-module~components-slide-toggle-components-slide-togg~a0b60a3e"), __webpack_require__.e("common"), __webpack_require__.e("pages-ui-forms-form-elements-form-elements-module")]).then(__webpack_require__.bind(null, /*! ./pages/ui/forms/form-elements/form-elements.module */ "./src/app/pages/ui/forms/form-elements/form-elements.module.ts")).then(function (m) { return m.FormElementsModule; }); },
                            data: {
                        ...
                        },
                        {
                            ...
                            loadChildren: function () { return Promise.all(/*! import() | pages-ui-forms-form-wizard-form-wizard-module */ [__webpack_require__.e("default~components-checkbox-components-checkbox-module~components-overview-components-overview-modul~2bad73dc"), __webpack_require__.e("default~components-overview-components-overview-module~components-snack-bar-components-snack-bar-mod~caef03c6"), __webpack_require__.e("default~contacts-table-contacts-table-module~pages-apps-clientes-aio-table-module~pages-apps-contrat~601e5afe"), __webpack_require__.e("default~pages-apps-clientes-aio-table-module~pages-apps-contratos-contratos-module~pages-dashboards-~fab076b6"), __webpack_require__.e("common"), __webpack_require__.e("pages-ui-forms-form-wizard-form-wizard-module")]).then(__webpack_require__.bind(null, /*! ./pages/ui/forms/form-wizard/form-wizard.module */ "./src/app/pages/ui/forms/form-wizard/form-wizard.module.ts")).then(function (m) { return m.FormWizardModule; }); },
                            data: {
                                containerEnabled: true,
                            },
                        },
                        {
                            path: "icons",
                            loadChildren: function () { return Promise.all(/*! import() | pages-ui-icons-icons-module */ [__webpack_require__.e("common"), __webpack_require__.e("pages-ui-icons-icons-module")]).then(__webpack_require__.bind(null, /*! ./pages/ui/icons/icons.module */ "./src/app/pages/ui/icons/icons.module.ts")).then(function (m) { return m.IconsModule; }); },
                        },
                        {
                            path: "page-layouts",
                            loadChildren: function () { return __webpack_require__.e(/*! import() | pages-ui-page-layouts-page-layouts-module */ "pages-ui-page-layouts-page-layouts-module").then(__webpack_require__.bind(null, /*! ./pages/ui/page-layouts/page-layouts.module */ "./src/app/pages/ui/page-layouts/page-layouts.module.ts")).then(function (m) { return m.PageLayoutsModule; }); },
                        },
                    ],
                },
                {
            ...
            var routes = [
                {
                    path: "login",
                    loadChildren: function () { return Promise.all(/*! import() | pages-pages-auth-login-login-module */ [__webpack_require__.e("default~components-checkbox-components-checkbox-module~components-overview-components-overview-modul~2bad73dc"), __webpack_require__.e("default~components-overview-components-overview-module~components-snack-bar-components-snack-bar-mod~caef03c6"), __webpack_require__.e("common"), __webpack_require__.e("pages-pages-auth-login-login-module")]).then(__webpack_require__.bind(null, /*! ./pages/pages/auth/login/login.module */ "./src/app/pages/pages/auth/login/login.module.ts")).then(function (m) { return m.LoginModule; }); },
                },
                {
                    path: "register",
                    loadChildren: function () { return Promise.all(/*! import() | pages-pages-auth-register-register-module */ [__webpack_require__.e("default~components-checkbox-components-checkbox-module~components-overview-components-overview-modul~2bad73dc"), __webpack_require__.e("common"), __webpack_require__.e("pages-pages-auth-register-register-module")]).then(__webpack_require__.bind(null, /*! ./pages/pages/auth/register/register.module */ "./src/app/pages/pages/auth/register/register.module.ts")).then(function (m) { return m.RegisterModule; }); },
                },
                {
                    path: "forgot-password",
                    loadChildren: function () { return Promise.all(/*! import() | pages-pages-auth-forgot-password-forgot-password-module */ [__webpack_require__.e("common"), __webpack_require__.e("pages-pages-auth-forgot-password-forgot-password-module")]).then(__webpack_require__.bind(null, /*! ./pages/pages/auth/forgot-password/forgot-password.module */ "./src/app/pages/pages/auth/forgot-password/forgot-password.module.ts")).then(function (m) { return m.ForgotPasswordModule; }); },
                },
                {
                    path: "coming-soon",
                    loadChildren: function () { return Promise.all(/*! import() | pages-pages-coming-soon-coming-soon-module */ [__webpack_require__.e("common"), __webpack_require__.e("pages-pages-coming-soon-coming-soon-module")]).then(__webpack_require__.bind(null, /*! ./pages/pages/coming-soon/coming-soon.module */ "./src/app/pages/pages/coming-soon/coming-soon.module.ts")).then(function (m) { return m.ComingSoonModule; }); },
                },
                {
                    path: "",
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(configService, styleService, iconRegistry, renderer, platform, document, localeId, layoutService, route, navigationService, splashScreenService) {
                    var _this = this;
                    this.configService = configService;
                    ...
                    this.route.queryParamMap
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_23__["filter"])(function (queryParamMap) { return queryParamMap.has("rtl") &&
                        ...
                        _this.document.body.dir = "rtl";
                        _this.configService.updateConfig({
                            rtl: true,
                        });
                    });
                    this.route.queryParamMap
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_23__["filter"])(function (queryParamMap) { return queryParamMap.has("layout"); }))
                        .subscribe(function (queryParamMap) { return _this.configService.setConfig(queryParamMap.get("layout")); });
                    this.route.queryParamMap
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_23__["filter"])(function (queryParamMap) { return queryParamMap.has("style"); }))
                        .subscribe(function (queryParamMap) { return _this.styleService.setStyle(queryParamMap.get("style")); });
        ...
        /***/ (function (module, exports) {
            module.exports = {
                ...
                theme: {
                    ...
                    backgroundColor: function (theme) { return (__assign({ base: 'var(--background-base)', card: 'var(--background-card)', 'app-bar': 'var(--background-app-bar)', hover: 'var(--background-hover)' }, theme('colors'))); },
                    backgroundPosition: {
                        bottom: 'bottom',
                        center: 'center',
                        left: 'left',
                    ...
                    borderColor: function (theme) { return (__assign({}, theme('colors'), { default: 'var(--foreground-divider)' })); },
                    borderRadius: {
                        none: '0',
                        sm: '0.125rem',
                        default: '0.25rem',
                    ...
                    height: function (theme) { return (__assign({ auto: 'auto' }, theme('spacing'), { full: '100%', screen: '100vh' })); },
                    inset: {
                        '0': '0',
                        '1': '0.25rem',
                        '2': '0.5rem',
                    ...
                    margin: function (theme, _a) {
                        ...
                        return (__assign({ auto: 'auto' }, theme('spacing'), negative(theme('spacing')), negative({
                            gutter: 'var(--padding-gutter)'
                        })));
                    },
                    maxHeight: {
                    ...
                    minWidth: function (theme) { return (__assign({ '0': '0', full: '100%' }, theme('spacing'))); },
                    objectPosition: {
                        bottom: 'bottom',
                        center: 'center',
                        left: 'left',
                    ...
                    textColor: function (theme) { return (__assign({ 'secondary': 'var(--text-secondary)', 'hint': 'var(--text-hint)' }, theme('colors'), { 'primary-contrast': {
                            50: '#000',
                            100: '#000',
                            200: '#000',
                            300: '#000',
                ...
                plugins: [
                    function (_a) {
                        ...
                        addVariant('ltr', function (_a) {
                            var separator = _a.separator, modifySelectors = _a.modifySelectors;
                            modifySelectors(function (_a) {
                                var className = _a.className;
                                return "[dir=ltr] .ltr" + e(separator) + className;
                            });
                        });
                        addVariant('rtl', function (_a) {
                            var separator = _a.separator, modifySelectors = _a.modifySelectors;
                            modifySelectors(function (_a) {
                                var className = _a.className;
