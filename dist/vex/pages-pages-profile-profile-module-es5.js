...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-pages-profile-profile-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProfileComponent = /** @class */ (function () {
                function ProfileComponent(apollo) {
                    var _this = this;
                    this.apollo = apollo;
                    this.loading = true;
                    this.links = [
                    ...
                    apollo
                        .watchQuery({
                        query: graphql_tag__WEBPACK_IMPORTED_MODULE_16___default.a(__makeTemplateObject(["\n          {\n            rates(currency: \"USD\") {\n              currency\n              rate\n            }\n          }\n        "], ["\n          {\n            rates(currency: \"USD\") {\n              currency\n              rate\n            }\n          }\n        "])),
                    })
                ...
                ProfileComponent.prototype.addFriend = function (friend) {
                    friend.added = true;
                };
                ProfileComponent.prototype.removeFriend = function (friend) {
                    friend.added = false;
                };
                ProfileComponent.prototype.trackByName = function (index, friend) {
                    return friend.name;
                };
